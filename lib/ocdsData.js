...
function awardObject(contract) {
  ...
  return {
    ...
    date,
    status,
    id: 0, // FIXME uniq per release, overwrite on import,
    value: {
...
export function contractObject(contract) {
  ...
  return {
    ...
    awardID: 0, // FIXME overwrite on import: award/id,
    period: {
    ...
    dateSigned: date,
    hasFramework: contract.CONTRATO_MARCO,
    framework: contract.IDENTIFICADOR_CM,
    filedMxCnet: contract.ARCHIVADO,
  };
}
